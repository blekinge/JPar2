/*
 *     FileDescriptionPacketTest.java
 ...
 */
public class FileDescriptionPacketTest extends TestCase {
    
    public FileDescriptionPacketTest(String testName) {
        super(testName);
    }      
    ...
    public void testReadMySelf() throws Exception{
        FileDescriptionPacket m1 = new FileDescriptionPacket(id, file);
        ByteBuffer d1 = m1.writePacket();
        FileDescriptionPacket m2 = new FileDescriptionPacket(new UnparsedPacket(d1));
        d1.rewind();
