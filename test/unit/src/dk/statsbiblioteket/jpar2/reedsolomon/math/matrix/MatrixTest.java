...
public class MatrixTest extends TestCase {
    ...
    public void testInvertAndMultGalois() throws NonInvertibleException,
        ...
        Matrix<Integer, Field<Integer>> orig =
                new Matrix<Integer, Field<Integer>>(side, side, gf, ba);
    ...
    public void testToString() {
        Matrix<Integer, GaloisField> test =
                Matrix.identity(5, new GaloisField(GaloisField.WordSize.FOUR));
